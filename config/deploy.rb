...
task :update_god, :roles=>:app do
  set :user, "mmangino"
  sudo "mkdir -p /etc/god.d/shared"
  sudo "cp #{current_path}/config/#{app_name}.god /etc/god.d"
  sudo "cp #{current_path}/lib/shared.god /etc/god.d/shared"
  sudo "god quit"
...
task :setup_logrotate do
  set :user, "mmangino"
  sudo "cp #{current_path}/config/logrotate/#{app_name} /etc/logrotate.d"
  sudo "cp #{current_path}/config/logrotate/#{app_name}.sh /etc/cron.hourly"
  sudo "chmod a+x /etc/cron.hourly/#{app_name}.sh"
end
# =============================================================================
# OPTIONAL VARIABLES
# =============================================================================
